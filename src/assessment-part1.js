...
fairyTale5 = fairyTale5.slice(0, 4)
...
String.prototype.grammarPolice = function() {
  ...
  for (var word of words) {
    wordArr = word.split("")
    var first = 0;
    while (wordArr[first].match(/[\W]/) && first < wordArr.length - 1) first++
    wordArr[first] = wordArr[first].toUpperCase()
    for (var i = first + 1; i < wordArr.length; i++) {
